    ...
    <div className="w-full h-auto flex flex-col items-center justify-center ">
      ...
      <section className="w-full my-6">
        <div className="w-full flex items-center justify-between">
          <p className="text-2xl font-semibold capitalize text-white relative before:absolute before:rounded-lg before:content before:w-32 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-red-500 to-red-600 transition-all ease-in-out duration-100">
            FOGON special :
          </p>
        ...
        <RowContainer
          ...
          flag={true}
          data={foodItems?.filter((n) => n.category === "staters")}
        />
      </section>
