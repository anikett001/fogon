    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-black">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          <img src={Logo} className="w-13 object-cover" alt="logo" />
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          <div
            ...
            onClick={showCart}
          >
            <MdShoppingBasket className="text-white hover:text-red-500 text-2xl  cursor-pointer" />
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "anikets9560@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
